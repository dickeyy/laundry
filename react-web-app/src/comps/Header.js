      ...
      <Box 
        ...
        >
            ...
            >   
                ...
                <Hide breakpoint='(max-width: 580px)'>
                    ...
                    {isHome ? (
                        ...
                        <>
                        <NavLink to={'/'}>
                            <Link mr={2} p={3} color={'white'} borderRadius={10} backgroundColor={'pink.500'} fontWeight={800} _hover={{textDecoration:"none"}}>
                                Home
                            </Link>
                        </NavLink>
                        ...
                        <>
                        <NavLink to={'/'}>
                            <Link mr={2} p={3} color={'white'} _hover={{ color: "pink.300", backgroundColor: 'whiteAlpha.100', borderRadius: 10}}>
                                Home
                            </Link>
                        </NavLink>
                        ...
                        <>
                        <NavLink to={'/'}>
                            <Link mr={2} p={3} _hover={{ color: "pink.300", backgroundColor: 'whiteAlpha.100', borderRadius: 10}}>
                                Home
                            </Link>
                        </NavLink>
            ...
            >
                ...
                <Text fontSize={25} ml={20} mr={2} fontWeight={800} mt={'-2'}>Laundry</Text>
                </Hide>
            </Box>
      </Box>
